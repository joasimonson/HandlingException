...
public class ServiceTests
{
    ...
    public async Task Operation_DateGreaterThanToday_ReturnsError()
    {
        ...
        var failureExpected = Result.Failure(new Error("Service.GreaterThanToday", "Operation date greater than today"));
    ...
    {
        // Arrange
        var failureExpected = Result.Failure(new Error("Service.InvalidOperation", "Invalid operation"));
